...
export default function page() {
    const array = [
        ...
        { id: 5, category: "Sport", title: "Title test", desc: "Lorem ipsum dolor sit amet consectetur,.", details: "NOV 17 2020", image: img },
    ...
    const filtreArray = array.filter((element) => element.category === "Sport")
    return (
        <>
            <Main>
                <Header />
                <Content arr={filtreArray} />
            </Main>
        </>
    )
};
