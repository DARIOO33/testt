...
export default function Blogs({ppp}) {
  ...
  <button class="bg-gray-300 hover:bg-gray-400 text-gray-800 font-bold py-2 px-8 rounded-l" onClick={prevPage}>
    Prev
  </button>
  <button class="bg-gray-300 hover:bg-gray-400 text-gray-800 font-bold py-2 px-8 rounded-r" onClick={nextPage}>
    Next
  </button>
</div>
        </div>
